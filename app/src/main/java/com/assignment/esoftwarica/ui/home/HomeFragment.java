...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("chubby", "admin", "Male", "10",R.drawable.noimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Gaurav thapaliya", "machapokari", "Female", "30", R.drawable.maleimg));
            studentsList.add(new Students("Balboa Gau", "Home", "male", "50", R.drawable.femaleimg));
